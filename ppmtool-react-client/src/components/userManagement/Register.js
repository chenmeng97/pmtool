                        ...
                        <div className="col-md-8 m-auto">
                            ...
                            <form onSubmit={this.onSubmit}>
                                <div className="form-group" style={{marginBottom: "5px"}}>
                                    <input 
                                        type="text" className={classnames("form-control form-control-lg", {"is-invalid": errors.fullName})} 
                                ...
                                <div className="form-group" style={{marginBottom: "5px"}}>
                                    <input 
                                        ...
                                        placeholder="Email Address (Username)" name="username" value={this.state.username}
                                        onChange={this.onChange}
                                    />
                                    {errors.username && (
